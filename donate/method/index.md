...
<img src="{{ '/styles/images/zhifubao.PNG' | prepend: site.baseurl }}" alt="支付宝二维码付款给Jacob" width="310" />
...
<img src="{{ '/styles/images/weixin.PNG' | prepend: site.baseurl }}" alt="支付宝二维码付款给Jacob" width="310" />
<br>
<br>
